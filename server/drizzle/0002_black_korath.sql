...
ALTER TABLE "user" ALTER COLUMN "phoneVerified" DROP DEFAULT;--> statement-breakpoint
ALTER TABLE "user" ALTER COLUMN "onboardingCompleted" DROP DEFAULT;--> statement-breakpoint
